    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "E_centerofinnovation.jsp">E.Center of Innovation</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">E.Center of innovation / excellence.</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form class = "formclass" action="E.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of Institute/Organization(if any)</h4>
                            <input type = "text" name="name" placeholder = "Name of Institute/Organization" value = "">

                            <h4>Area/Title/Scope</h4>
                            <input type = "text" name="area" placeholder = "Area/Title/Scope">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Investment</h4>
                            <input type = "text" name="invest" placeholder = "Investment">

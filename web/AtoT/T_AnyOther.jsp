    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "T_AnyOther.jsp">T.Any Other Info</a></li>
            </ul>
        </div>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">T.Any Other Info</h3>
        </div>



            <div class="outer-formclass">
                <form class = "formclass" action="t.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of the Activity</h4>
                            <input type = "text" name="Name_of_activity" placeholder = "Name of the Activity" value = "">

                            <h4>Organizer</h4>
                            <input type = "text" name="Organizer" placeholder = "Organizer" value = "">

                            <h4>Name/No. of participants</h4>
                            <input type = "text" name="Name_of_participants" placeholder = "Name/No. of participants" value = "">
                            <br>
                    </div>
                    <div class="right-formclass">
                            ...
                            <input type = "text" name="Prize" placeholder = "Prize  / Rank Obtained">

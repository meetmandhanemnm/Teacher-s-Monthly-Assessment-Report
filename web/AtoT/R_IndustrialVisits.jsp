    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "R_IndustrialVisits.jsp">R.Industrial Visits</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">R.Industrial Visits</h3>
        </div>



            <div class="outer-formclass">
                <form class = "formclass" action="r.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name and address of the  Company / Industry visited</h4>
                            <input type = "text" name="Name_of_cmp" placeholder = "Name and address of the  Company / Industry visited" value = "">

                            <h4>Purpose of the visit</h4>
                            <input type = "text" name="Purpose" placeholder = "Purpose of the visit" value = "">

                            <h4>No. of students</h4>
                            <input type = "number" min="0" name="No_of_stds" placeholder = "No. of students" value = "">
                            <br>
                    </div>
                    <div class="right-formclass">
                            ...
                            <h4>Coordinator(s)</h4>
                            <input type = "text"  name="Coordinators" placeholder = "Coordinator(s)">

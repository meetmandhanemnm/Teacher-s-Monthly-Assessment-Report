...
<html>
    <head>
        <meta http-equiv="Refresh" content="1.5;url=J_Patent.jsp"/>
...
<div class="wrapper-heading">
        ...
        if(session.getAttribute("tid")==null)
        {
            ...
            String query="insert into I_consultancy(name,client,title,amount,tid,sdate,Remark) values ('"+name+"','"+client+"','"+title+"','"+amount+"','"+tid+"','"+sdate+"','"+remark+"')";
            st.executeUpdate(query);
            //response.sendRedirect("J_Patent.jsp");
            }
            catch(Exception e)
            {
                out.println(e);

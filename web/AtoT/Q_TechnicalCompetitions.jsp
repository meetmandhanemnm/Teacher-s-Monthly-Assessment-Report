...
<div class = "wrappernavbar">
    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
               ...
               <li><a href = "A_seminars.jsp">A.Seminars</a></li>
                ...
                <li class = "active" ><a href = "Q_TechnicalCompetitions.jsp">Q.Technical Competitions</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">Q.Technical Competitions</h3>
        </div>



            <div class="outer-formclass">
                <form class = "formclass" action="q.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of Technical Competition/Techfest</h4>
                            <input type = "text" name="Name_of_compt" placeholder = "Name of Technical Competition/Techfest" value = "">

                            <h4>No. of Participants</h4>
                            <input type = "number"  min="0" name="No_of_participants" placeholder = "No. of Participants" value = "">

                            <h4>Duration</h4>
                            <input type = "text" name="Duration" placeholder = "Duration" value = "">

                            <h4>Date</h4>
                            <input type = "date" name="sdate" placeholder = "Date" value = "" required>
                            <br>
                    </div>
                    <div class="right-formclass">

                            <h4>Name of student / Staff Participated</h4>
                            <input type = "text" name="Name_of_std" placeholder = "Name of student / Staff Participated">

                            <h4>Prize/Rank obtained</h4>
                            <input type = "renk" name="Prize" placeholder = "Prize/Rank obtained">

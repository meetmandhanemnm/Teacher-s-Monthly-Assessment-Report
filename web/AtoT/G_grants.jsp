...
<div class = "wrappernavbar">
 ...
 <button type="button" name="button">contact us</button>
        ...
        </form> <!-- <button type="button" name="button"><i class = "fa fa-paper-plane icon-class"></i>Log in</button> -->
      ...
      <div class = "left-box" id = "left-box">
          <button onclick="list_close()" id = "list-button" > <i class="arrow fa fa-angle-double-left"></i></button>
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "G_grants.jsp">G.Grants received</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">G.Grants received</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form class = "formclass" method="post" action="G.jsp" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of Principal Investigator</h4>
                            <input type = "text" name="nopinvest" placeholder = "Name of Principal Investigator" value = "">

                            <h4>Name of Grant</h4>
                            <input type = "text" name="nogrant" placeholder = "Name of Grant">

                            <h4>Sanctioning Authority</h4>
                            <input type = "text" name="sauthority" placeholder = "Sanctioning Authority">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Period of Grant</h4>
                            <input type = "text" name="pogrant" placeholder = "Period of Grant">

                            <h4>Sanctioned order no.</h4>
                            <input type = "text" name="sorderno" placeholder = "Sanctioned order no.">

                            <h4>Date of sanction</h4>
                            <input type = "date" name="dosanction" placeholder = "[dd/mm/yyyy]" required>

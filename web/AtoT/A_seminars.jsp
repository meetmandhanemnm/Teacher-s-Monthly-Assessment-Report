<%-- 
    Document   : A_seminars
    Created on : 12 May, 2020, 11:55:35 AM
...
<%@page import="java.util.*"%><%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "A_seminars.jsp">A.Seminars</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">A.Conferences, Seminars, Symposia, Workshops, FDP, STTP Organized /conducted.</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form method="post" action="A.jsp" class = "formclass" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Activity/Event</h4>
                            <input name="event" type = "text" placeholder = "Activity/Events" value = "">
                            ...
                            <h4>Sponsoring Authority</h4>
                            <input name="sponsor" type = "text" placeholder = "Sponsoring Authority" value = "">
                            
                            <h4>Name of the  coordinator(s)</h4>
                            <input name="name" type = "text" placeholder = "Name of the  coordinator(s)">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>No. of Participants</h4>
                            <input name="participants" type = "number" min="0" placeholder = "No. of Participants">

                            <h4>Name of the resource person</h4>
                            <input name="namerp" type = "text" placeholder = "Name of the resource person">
                            
                            <h4>Company name of the resource person</h4>
                            <input name="companyrp" type = "text" placeholder = "Company name of the resource person">

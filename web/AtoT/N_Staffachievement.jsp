    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "N_Staffachievement.jsp">N.Staff Achievements</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">N.Staff Achievements</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action = "N.jsp"  method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of staff</h4>
                            <input type = "text" placeholder = "Name of staff" value = "" name = "nofstaff" >
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Date</h4>
                            <input type = "date" placeholder = "Date" name = "sdate" required >
                            <br>

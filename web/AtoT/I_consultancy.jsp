      ...
      <div class = "left-box" id = "left-box">
          <button onclick="list_close()" id = "list-button" > <i class="arrow fa fa-angle-double-left"></i></button>
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "I_consultancy.jsp">I.Consultancy Projects</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">I.Consultancy Projects</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form class = "formclass" action="I.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of faculty(Chief Consultant)</h4>
                            <input type = "text" name="name" placeholder = "Name of faculty(Chief Consultant)" value = "">

                            <h4>Client Organization</h4>
                            <input type = "text" name="client" placeholder = "Client Organization">
                            
                            <h4>Title of Consultancy of project</h4>
                            <input type = "text" name="title" placeholder = "Title of Consultancy of project">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Amount received(in Rs.)</h4>
                            <input type = "text" name="amount" placeholder = "Amount received(in Rs.)">

    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "F_industry.jsp">F.Industry sponsored labs</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">F.Industry sponsored lab</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form class = "formclass" action="F.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of sponsoring Industry/Company</h4>
                            <input type = "text" name="nsin" placeholder = "Name of sponsoring Industry/Company" value = "">

                            <h4>Name of sponsored lab</h4>
                            <input type = "text" name="nsl" placeholder = "Name of sponsored lab">
                            
                            <h4>Year of establishment</h4>
                            <input type = "text" name="year" placeholder = "Year of establishment">
                    ...
                    <div class="right-formclass">
                            ...
                            <input type = "text" name="type" placeholder = "Type of support">
                            
                            <h4>Date</h4>
                            <input type = "date" name="sdate" placeholder = "[dd/mm/yyyy]" required>

                            <h4>Grant(in Rs.)</h4>
                            <input type = "text" name="grantrs" placeholder = "Grant(in Rs.)">

...
<html>
    <head>
        <meta http-equiv="Refresh" content="1.5;url=O_Studentachievement.jsp"/>
 <title>Submitted Successfully</title>
    ...
    <body>
        ...
        if(session.getAttribute("tid")==null)
        {
            ...
            String query="insert into N_Staffachievement(nofstaff,remark,achievement,sdate,tid) values ('"+nofstaff+"','"+remark+"','"+achievement+"','"+sdate+"','"+tid+"')";
            st.executeUpdate(query);
           // response.sendRedirect("O_Studentachievement.jsp");
            }
            catch(Exception e)
            {
                out.println(e);

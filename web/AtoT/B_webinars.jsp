<%-- 
    Document   : B_webinars
    Created on : 12 May, 2020, 11:56:01 AM
    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "B_webinars.jsp">B.Webinars</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">B.Webinar / video conference /Invited talks organized /conducted.</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form method="post" action="B.jsp" class = "formclass" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">
                            ...
                            <input name="name" type = "text" placeholder = "Speaker/Resource Person">

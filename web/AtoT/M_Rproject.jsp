    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "M_Rproject.jsp">M.Research Projects</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">M.Research Projects</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action = "M.jsp"  method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of the Investigator(s)</h4>
                            <input type = "text" placeholder = "Name of the Investigator(s)" value = "" name = "nofinv">

                            <h4>Faculty(Stream)</h4>
                            <input type = "text" placeholder = "Faculty(Stream)" name = "faculty" >

                            <h4>Title of the Research Project/Scheme</h4>
                            <input type = "text" placeholder = "Title of the Research Project/Scheme" name = "tofproject" >

                            <h4>Sanctioned order number</h4>
                            <input type = "text" placeholder = "Sanctioned order number" name = "snumber " >

                             <h4>Sanctioned order Date</h4>
                            <input type = "date" placeholder = "Sanctioned order Date" name = "sdate" required >

                            <br>
                    </div>
                    <div class="right-formclass">

                      <h4>Name of the Funding Agency</h4>
                      <input type = "text" placeholder = "Name of the Funding Agency" name = "noffunding" >

                      <h4>Duration of the Project/Scheme(Months)</h4>
                      <input type = "number" min="0" placeholder = "Duration of the Project/Scheme(Dates)" value = "" name = "duration" >

                      <h4>Amount Sanctioned(Rs.)</h4>
                      <input type = "text" placeholder = "Amount Sanctioned(Rs.)" name = "amount" >

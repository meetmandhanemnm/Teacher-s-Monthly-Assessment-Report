      ...
      <div class = "left-box" id = "left-box">
          <button onclick="list_close()" id = "list-button" > <i class="arrow fa fa-angle-double-left"></i></button>
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "H_financial.jsp">H.Financial support to students</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">H.Financial support provided to students</h3>
        </div>
            ...
            <div class="outer-formclass">
                <form class = "formclass" action="H.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Academic Year</h4>
                            <input type = "text" name="year" placeholder = "Academic Year" value = "">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Financial support provided</h4>
                            <input type = "text" name="finsup" placeholder = "Financial support provided">

                            <h4>No. of students availing the support</h4>
                            <input type = "number" min="0" name="nos" placeholder = "No. of students availing the support">

...
<div class = "wrappernavbar">
    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
               ...
               <li><a href = "D_collaborations.jsp">D.Collaborations</a></li>
                ...
                <li class = "active" ><a href = "S_ResourcePerson.jsp">S.Resource Person</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">S.Resource Person</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action="s.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of faculty</h4>
                            <input type = "text" name="Name_of_faculty"  placeholder = "Name of faculty" value = "">

                            <h4>Name of FDP/workshop/other</h4>
                            <input type = "text" name="Name_of_workshop" placeholder = "Name of FDP/workshop/other" value = "">
                    ...
                    <div class="right-formclass">
                            ...
                            <h4>Organizers</h4>
                            <input type = "text" name="Organizers" placeholder = "Organizers">

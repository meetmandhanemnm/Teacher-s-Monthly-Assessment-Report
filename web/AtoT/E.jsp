...
<html>
    <head>
        <meta http-equiv="Refresh" content="1.5;url=F_industry.jsp"/>
 <title>Submitted Successfully</title>
    ...
    <body>
         ...
         <% 
            ...
            String query="insert into E_centerofinnovation(name,area,sdate,invest,remark,tid) values ('"+name+"','"+area+"','"+sdate+"','"+invest+"','"+remark+"','"+tid+"')";
            st.executeUpdate(query);
           // response.sendRedirect("F_industry.jsp");
            }
            catch(Exception e)
            {
                out.println(e);

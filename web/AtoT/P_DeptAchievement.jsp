    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "P_DeptAchievement.jsp">P.Departmental Achievements</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">P.Departmental Achievements</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action="p.jsp" method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">
                            ...
                            <h4>Date</h4>
                            <input type = "date" name="sdate" placeholder = "[dd/mm/yyyy]" value = "" required>
                            <br>
                    </div>

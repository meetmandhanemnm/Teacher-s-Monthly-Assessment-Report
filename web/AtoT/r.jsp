...
<html>
    <head>
        <meta http-equiv="Refresh" content="1.5;url=S_ResourcePerson.jsp"/>
 <title>Submitted Successfully</title>
    ...
    <body>
        ...
        if(session.getAttribute("tid")==null)
        {
            ...
            String Name_of_cmp=request.getParameter("Name_of_cmp");
            String Purpose=request.getParameter("Purpose");
            String No_of_stds=request.getParameter("No_of_stds");
            ...
            String query="insert into R_IndustrialVisits(Name_of_cmp,Purpose,No_of_stds,Coordinators,sdate,tid,Remark) values ('"+Name_of_cmp+"','"+Purpose+"','"+No_of_stds+"','"+Coordinators+"','"+Date+"','"+tid+"','"+remark+"')";
            st.executeUpdate(query);
            //response.sendRedirect("S_ResourcePerson.jsp");
            }
            catch(Exception e)
            {
                out.println(e);

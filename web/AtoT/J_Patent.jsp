    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "J_Patent.jsp">J.Patents</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">J.Patent</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action = "J.jsp"  method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">

                            <h4>Name of the staff</h4>
                            <input type = "text" placeholder = "Name of the staff" value = "" name = "nofstaff">

                            <h4>Title of patent filed</h4>
                            <input type = "text" placeholder = "Title of patent filed" name = "pfiled">

                            <h4>Patent published Yes/No (year)</h4>
                            <input type = "text" placeholder = "Patent published Yes/No (year)" name = "ppublished">

                            <h4>Date of publishing</h4>
                            <input type = "date" placeholder = "Date of publishing" name = "dpublished" required>

                            <br>
                    </div>
                    <div class="right-formclass">

                      <h4>Patent granted Yes/No (year)</h4>
                      <input type = "text" placeholder = "Patent granted Yes/No (year)" value = "" name = "pgranted">

                      <h4>Patents licensed Yes/No (year)</h4>
                      <input type = "text" placeholder = "Title of patent filed" name = "plicensed">

                      <h4>Earning from Patents(Amount in Rs.)</h4>
                      <input type = "text" placeholder = "Earning from Patents(Amount in Rs.)" name = "pearning">

    ...
    <div class= "outer-box">
        <div class = "left-box" id = "left-box">
            ...
            <ul class = "vertical-list">
                ...
                <li class = "active" ><a href = "K_Book.jsp">K.Books</a></li>
        ...
        <div class = "wrapper-subheading">
            <h3 class = "right-sub-heading">K.Books/Books Chapter</h3>
        </div>


            <div class="outer-formclass">
                <form class = "formclass" action = "K.jsp"  method="post" autocomplete="off">
                <div class = "wrapperformclass">
                    <div class="left-formclass">
                            ...
                            <h4>Title of the Reference Books/Monographs</h4>
                            <input type = "text" placeholder = "Title of patent filed" name = "tbook">

                            <h4>Name and place of publisher(s)</h4>
                            <input type = "text" placeholder = "Patent published Yes/No (year)" name = "nofpub">
                    ...
                    <div class="right-formclass">
                      ...
                      <h4>Link(in case of soft copy)</h4>
                      <input type = "text" placeholder = "Link(in case of soft copy)" name = "link" >

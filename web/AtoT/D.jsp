...
<html>
    <head>
        <meta http-equiv="Refresh" content="1.5;url=E_centerofinnovation.jsp"/>
    ...
    <body>
        <div class="wrapper-heading">
         ...
         <% 
            ...
            String query="insert into D_collaborations(name,collab,sdate,edate,Remark,scope,tid) values ('"+name+"','"+collab+"','"+sdate+"','"+edate+"','"+remark+"','"+scope+"','"+tid+"')";
            st.executeUpdate(query);
           // response.sendRedirect("E_centerofinnovation.jsp");
            }
            catch(Exception e)
            {
                out.println(e);
